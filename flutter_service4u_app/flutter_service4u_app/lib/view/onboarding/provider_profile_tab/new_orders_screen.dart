...
class NewOrdersScreen extends StatelessWidget {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: ButtonBar(
                    ...
                    children: [
                      TextButton(
                        onPressed: () => _updateOrderStatus(order.id, 'accepted', data['order_number']),
                        child: const Text('Accept', style: TextStyle(color: Colors.green)),
                      ),
                      TextButton(
                        onPressed: () => _updateOrderStatus(order.id, 'canceled', data['order_number']),
  ...
  void _updateOrderStatus(String orderId, String newStatus, String orderNumber) {
